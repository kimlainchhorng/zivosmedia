...
Generated: 2026-09-05T21:46:42.100Z
...
- Remote migration versions: 1774
- Exact version matches: 764
- One-to-one likely timestamp-drift matches: 17
- High-confidence one-to-one matches: 3
- Medium-confidence one-to-one matches: 14
- Unmatched local migrations: 397
- Unmatched local migrations inside remote version range: 397
...
3. unmatched local migrations after candidates (397 items)
