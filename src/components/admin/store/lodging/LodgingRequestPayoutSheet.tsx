...
export default function LodgingRequestPayoutSheet({
  storeId,
  storeCountry,
  availableCents,
  open,
  ...
  const { data: methods = [], isLoading: methodsLoading } = useQuery({
    ...
    queryFn: async (): Promise<MethodRow[]> => {
      return (await loadOwnPayoutMethods("store", storeId)) as MethodRow[];
    },
    enabled: !!user?.id && !!storeId && open,
  });
  ...
  const submit = async () => {
    ...
    try {
      ...
      queryClient.invalidateQueries({ queryKey: ["lodge-payout-history"] });
      onOpenChange(false);
      setNote("");
    } catch (e: any) {
          ...
          <div className="mt-4 space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              {methodsLoading ? (
                ...
                <p className="text-xs text-muted-foreground">
                  No payout methods saved yet. Add one in the Payout account
                  section above.
                </p>
              ) : (
                <div className="space-y-1.5">
                      ...
                      >
                        <div className="flex items-center gap-2">
                          ...
                          {m.verification_status === "verified" ? (
                            <span className="text-[10px] rounded bg-emerald-500/15 text-emerald-700 px-1.5 py-0.5">
                              Verified
                            </span>
                          ) : (
            ...
            <div className="space-y-1.5">
              ...
              <Textarea
                ...
                placeholder="e.g. preferred transfer time"
              />
            </div>
