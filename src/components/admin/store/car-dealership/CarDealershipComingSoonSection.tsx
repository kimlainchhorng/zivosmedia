/**
 * CarDealershipComingSoonSection — branded placeholder shown for dealership
 * tabs that don't yet have a full implementation.
 */
import type { LucideIcon } from "lucide-react";
import { Sparkles } from "lucide-react";

interface CarDealershipComingSoonSectionProps {
  title: string;
  description?: string;
  Icon?: LucideIcon;
  bullets?: string[];
...
export default function CarDealershipComingSoonSection({
  title,
  description,
  Icon = Sparkles,
  bullets,
}: CarDealershipComingSoonSectionProps) {
  return (
