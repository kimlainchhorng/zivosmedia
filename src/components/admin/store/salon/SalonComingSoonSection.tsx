/**
 * SalonComingSoonSection — branded placeholder shown for salon tabs that
 * don't yet have a full implementation. Each tab can later be swapped for
 * a real component by replacing its TabsContent entry in AdminStoreEditPage.
 */
import type { LucideIcon } from "lucide-react";
import { Sparkles } from "lucide-react";

interface SalonComingSoonSectionProps {
  title: string;
  description?: string;
  Icon?: LucideIcon;
  bullets?: string[];
...
export default function SalonComingSoonSection({
  title,
  description,
  Icon = Sparkles,
  bullets,
}: SalonComingSoonSectionProps) {
  return (
