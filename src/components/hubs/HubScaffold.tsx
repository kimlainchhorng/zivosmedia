      ...
      <main className="pt-safe-header pb-24">
            ...
            >
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-5 py-2.5 rounded-xl border border-border bg-background text-sm font-semibold hover:bg-muted/50 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
                >
        ...
        <section className="container mx-auto px-4 pt-2 pb-10 sm:pb-14">
          <div className="rounded-2xl border border-border bg-card/50 p-6 sm:p-8">
            ...
            <ol className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto list-none p-0 m-0">
              {steps.map((step, i) => {
                ...
                return (
                  <motion.li
                    ...
                    animate={reduce ? undefined : { opacity: 1, y: 0 }}
                    transition={reduce ? undefined : { duration: 0.4, delay: i * 0.08 }}
                  ...
                  >
                    <div className="relative w-12 h-12 rounded-full bg-gradient-to-br from-fuchsia-500/10 to-orange-500/10 border border-border flex items-center justify-center text-fuchsia-500">
                      ...
                      <span aria-hidden className="absolute -top-1 -right-1 w-5 h-5 rounded-full bg-ig-gradient text-white text-[10px] font-bold flex items-center justify-center">{i + 1}</span>
                    </div>
