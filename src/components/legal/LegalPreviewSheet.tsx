...
const TERMS_SECTIONS = [
  { title: "1. Who We Are", body: "ZIVO is a global travel, social, and lifestyle platform operated by ZIVO LLC. We provide search, booking referral, social feed, reels, chat, ride, food, and grocery services. Some features are operated by partners (merchants of record)." },
  { title: "2. Eligibility & Age", body: "You must be at least 13 to create a personal account and at least 18, or the age of legal majority, to book travel, make payments, receive marketplace payouts, or use business tools. Some features may require additional verification (ID, phone, payment method)." },
  ...
  { title: "7. Acceptable Use", body: "Don't post or send: illegal or sexually explicit content, hate speech, harassment, sexual content involving minors, non-consensual intimate imagery, terrorism, scams, spam, malware, IP infringement, or doxxing. Don't scrape, reverse-engineer, or interfere with the platform. Don't use ZIVO to launder money, transmit funds between people, or evade sanctions." },
  { title: "8. Prohibited Sexual Content", body: "Pornography, sexually explicit content, sexual services, and non-consensual intimate imagery are not permitted on ZIVO. We may remove prohibited content and restrict or close accounts that publish, sell, request, or promote it." },
  { title: "9. Business and Service-Partner Settlements", body: "Approved drivers, restaurants, merchants, and other service partners may receive settlements for completed rides, deliveries, orders, or separately approved affiliate services. Settlement eligibility and timing follow the applicable partner agreement and verification requirements." },
  { title: "10. Calls & Chat", body: "Calls and chat may be moderated by automated systems and human reviewers for safety. Recording others without consent where prohibited by law is forbidden. Group calls must follow community guidelines." },
  ...
  { title: "13. Intellectual Property", body: "ZIVO, the Z logo, and all platform software are owned by ZIVO LLC. You may not copy, modify, or create derivative works of the platform. Report copyright infringement under the DMCA to copyright@zivosmedia.com." },
  ...
  { title: "18. Disputes & Arbitration", body: "Most disputes are resolved through binding individual arbitration under the rules of the AAA, seated in the United States, and governed by the laws of the State of Delaware. You waive class actions. You may opt out of arbitration within 30 days of accepting these Terms by emailing legal@zivosmedia.com." },
  ...
  { title: "20. Contact", body: "Questions: legal@zivosmedia.com · Safety: safety@zivosmedia.com · Copyright: copyright@zivosmedia.com · Mail: ZIVO LLC, United States." },
];

const PRIVACY_SECTIONS = [
  { title: "1. What We Collect", body: "Account info (name, email, phone, password hash, date of birth), profile content (photo, bio, posts, reels, messages), bookings and orders, payment info (processed by Stripe — we don't store full card numbers), location (with permission), device and usage data, contacts (with permission), and customer support communications." },
  { title: "2. How We Use Data", body: "Operate accounts and bookings; rank feed/reels/search; personalize content and ads; process customer payments and marketplace partner settlements; prevent fraud, spam, and abuse; moderate content; deliver notifications; provide AI assistance; comply with legal obligations; and improve the platform." },
  ...
  { title: "8. Content Moderation & Safety", body: "Posts, reels, and messages may be scanned by automated systems and reviewed by trained moderators to detect CSAM, terrorism, fraud, spam, and policy violations. We report illegal content to NCMEC and law enforcement as required by law." },
  { title: "9. Children's Privacy", body: "ZIVO is not for children under 13 (under 16 in some regions). We do not knowingly collect data from children. If you believe a child has an account, contact privacy@zivosmedia.com — we'll delete it." },
  { title: "10. Your Rights", body: "Access, correct, export, restrict, object, or delete your data. EU/UK residents have GDPR rights; California residents have CCPA/CPRA rights (including 'Do Not Sell or Share'); Brazilian residents have LGPD rights. Submit requests in Settings → Privacy or email privacy@zivosmedia.com." },
  ...
  { title: "13. Security", body: "We use TLS encryption in transit, AES-256 at rest for sensitive data, hashed passwords, Row-Level Security on databases, audit logging, 2FA for admins, and rate limiting. No system is 100% secure — report concerns to security@zivosmedia.com." },
  ...
  { title: "18. Contact Our Privacy Team", body: "Privacy: privacy@zivosmedia.com · DPO (EU): dpo@zivosmedia.com · Mail: ZIVO LLC, United States. We respond to verified requests within 30 days (45 in some regions)." },
];
