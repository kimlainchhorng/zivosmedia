...
const TERMS_SECTIONS = [
  ...
  { title: "13. Intellectual Property", body: "ZIVO, the Z logo, Z Coins, and all platform software are owned by ZIVO LLC. You may not copy, modify, or create derivative works of the platform. Report copyright infringement under the DMCA to copyright@zivosmedia.com." },
