/**
 * BusInlinePaymentForm — embedded Stripe PaymentElement for the bus booking
 * flow. Authorize-only (manual capture): the card is authorised at booking and
 * captured when the operator confirms the trip. Mirrors
 * CarRentalInlinePaymentForm so the payment UX matches other ZIVO surfaces.
 */
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <p className="text-[11px] text-muted-foreground text-center px-2">
        We&apos;ll authorise the fare now. Your card isn&apos;t charged until the operator confirms your seats.
      </p>
