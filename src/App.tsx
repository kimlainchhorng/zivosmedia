...
const AffiliateRedirectPage = lazy(
  () => import("@/pages/AffiliateRedirectPage"),
);
...
const JobPostingDetailPage = lazy(
  () => import("@/pages/hubs/JobPostingDetailPage"),
);
const StartVoiceRoomPage = lazy(
  () => import("@/pages/hubs/StartVoiceRoomPage"),
);
const VoiceRoomDetailPage = lazy(
  () => import("@/pages/hubs/VoiceRoomDetailPage"),
);
...
function ChannelShareRedirect() {
  ...
  const target = handle
    ? `/c/${encodeURIComponent(handle)}${location.search}${location.hash}`
    : `/channels${location.search}${location.hash}`;
...
const PWAInstallBanner = lazyWithRetry(() =>
  import("./components/shared/PWAInstallBanner").then((m) => ({
    default: m.PWAInstallBanner,
  })),
);
const InAppBrowserInterstitial = lazyWithRetry(
  () => import("./components/shared/InAppBrowserInterstitial"),
);
const PaymentReturnHandler = lazyWithRetry(() =>
  import("@/components/lodging/PaymentReturnHandler").then((m) => ({
    default: m.PaymentReturnHandler,
  })),
);
const IncomingCallListener = lazyWithRetry(
  () => import("@/components/chat/IncomingCallListener"),
);
const ChatNotificationListener = lazyWithRetry(
  () => import("@/components/chat/ChatNotificationListener"),
);
...
const AdminShellRoute = lazyWithRetry(() =>
  import("@/components/admin/shell/AdminShellRoute").then((m) => ({
    default: m.AdminShellRoute,
  })),
);
const PushNotificationsBootstrap = lazyWithRetry(() =>
...
if (ENABLE_DEV_ROUTES) {
  PostMenuRegressionPage = lazy(
    () => import("./pages/dev/PostMenuRegressionPage"),
  );
...
const EcosystemPrototype = lazy(
  () => import("./pages/prototype/EcosystemPrototype"),
);
...
const EstimateApprovalPage = lazy(() =>
  lazyRetry(() => import("./pages/EstimateApprovalPage")),
);
const RepairStatusPage = lazy(() =>
  lazyRetry(() => import("./pages/RepairStatusPage")),
);
const InspectionViewPage = lazy(() =>
  lazyRetry(() => import("./pages/InspectionViewPage")),
);
...
const ZivoTravelPaymentMethods = lazy(
  () => import("./pages/ZivoTravelPaymentMethods"),
);
...
const AdminDriverModerationPage = lazy(
  () => import("./pages/admin/AdminDriverModerationPage"),
);
const AdminTripHeatmapPage = lazy(
  () => import("./pages/admin/AdminTripHeatmapPage"),
);
const AdminRefundsPage = lazy(() => import("./pages/admin/AdminRefundsPage"));
const AdminDriverPayoutsPage = lazy(
  () => import("./pages/admin/AdminDriverPayoutsPage"),
);
const AdminEatsPayoutsPage = lazy(
  () => import("./pages/admin/AdminEatsPayoutsPage"),
);
const AdminMessageModerationPage = lazy(
  () => import("./pages/admin/AdminMessageModerationPage"),
);
const AdminCallClosuresPage = lazy(
  () => import("./pages/admin/AdminCallClosuresPage"),
);
const AdminModerationQAPage = lazy(
  () => import("./pages/admin/AdminModerationQAPage"),
);
const AdminMarketingResponsiveQA = lazy(
  () => import("./pages/admin/AdminMarketingResponsiveQA"),
);
...
const ShopEmployeesPage = lazy(
  () => import("./pages/app/shop/ShopEmployeesPage"),
);
const ShopEmployeeDetailPage = lazy(
  () => import("./pages/app/shop/ShopEmployeeDetailPage"),
);
const ShopPayrollPage = lazy(() => import("./pages/app/shop/ShopPayrollPage"));
const ShopEmployeeSchedulePage = lazy(
  () => import("./pages/app/shop/ShopEmployeeSchedulePage"),
);
const ShopTimeClockPage = lazy(
  () => import("./pages/app/shop/ShopTimeClockPage"),
);
const ShopEmployeeRulesPage = lazy(
  () => import("./pages/app/shop/ShopEmployeeRulesPage"),
);
const ShopAttendancePage = lazy(
  () => import("./pages/app/shop/ShopAttendancePage"),
);
const ShopTrainingPage = lazy(
  () => import("./pages/app/shop/ShopTrainingPage"),
);
const ShopPerformancePage = lazy(
  () => import("./pages/app/shop/ShopPerformancePage"),
);
const ShopDocumentsPage = lazy(
  () => import("./pages/app/shop/ShopDocumentsPage"),
);
const TruckDashboardPage = lazy(
  () => import("./pages/app/shop/TruckDashboardPage"),
);
const SalesAttributionPage = lazy(
  () => import("./pages/app/shop/SalesAttributionPage"),
);
const SandboxModePage = lazy(() => import("./pages/app/shop/SandboxModePage"));
const MerchantROIDashboard = lazy(
  () => import("./pages/app/shop/MerchantROIDashboard"),
);
const ReferAShopPage = lazy(() => import("./pages/app/shop/ReferAShopPage"));
const ShopProductsPage = lazy(
  () => import("./pages/app/shop/ShopProductsPage"),
);
const ShopOrdersPage = lazy(() => import("./pages/app/shop/ShopOrdersPage"));
const ShopSettingsPage = lazy(
  () => import("./pages/app/shop/ShopSettingsPage"),
);
const ShopPromotionsPage = lazy(
  () => import("./pages/app/shop/ShopPromotionsPage"),
);
const ShopAnalyticsPage = lazy(
  () => import("./pages/app/shop/ShopAnalyticsPage"),
);
const ShopPaymentsPage = lazy(
  () => import("./pages/app/shop/ShopPaymentsPage"),
);
const ShopDeliveryPage = lazy(
  () => import("./pages/app/shop/ShopDeliveryPage"),
);
const ReferAFriendPage = lazy(() => import("./pages/app/ReferAFriendPage"));
const MetaPrivacyDisclosure = lazy(
  () => import("./pages/legal/MetaPrivacyDisclosure"),
);
const InsuranceDisclosure = lazy(
  () => import("./pages/legal/InsuranceDisclosure"),
);
const InsurancePolicy = lazy(() => import("./pages/legal/InsurancePolicy"));
const AirportTransfersPage = lazy(
  () => import("./pages/seo/AirportTransfersPage"),
);
const CarRentalCityPage = lazy(() => import("./pages/seo/CarRentalCityPage"));
const DestinationActivitiesPage = lazy(
  () => import("./pages/seo/DestinationActivitiesPage"),
);
const DestinationHotelsPage = lazy(
  () => import("./pages/seo/DestinationHotelsPage"),
);
...
const ApplyJobHubPage = lazy(
  () => import("./pages/app/personal/ApplyJobHubPage"),
);
const FindEmployeePage = lazy(
  () => import("./pages/app/personal/FindEmployeePage"),
);
const CompanyDetailPage = lazy(
  () => import("./pages/app/personal/CompanyDetailPage"),
);
const JobDetailPage = lazy(() => import("./pages/app/personal/JobDetailPage"));
const MyApplicationsPage = lazy(
  () => import("./pages/app/personal/MyApplicationsPage"),
);
const EmployerDashboardPage = lazy(
  () => import("./pages/app/personal/EmployerDashboardPage"),
);
const JobApplicantsPage = lazy(
  () => import("./pages/app/personal/JobApplicantsPage"),
);
const PersonalEmployeesPage = lazy(
  () => import("./pages/app/personal/PersonalEmployeesPage"),
);
const AcceptInvitePage = lazy(() => import("./pages/auth/AcceptInvitePage"));
const PersonalSchedulePage = lazy(
  () => import("./pages/app/personal/PersonalSchedulePage"),
);
const PersonalTimesheetPage = lazy(
  () => import("./pages/app/personal/PersonalTimesheetPage"),
);
const PersonalPayStubsPage = lazy(
  () => import("./pages/app/personal/PersonalPayStubsPage"),
);
const PersonalNotificationsPage = lazy(
  () => import("./pages/app/personal/PersonalNotificationsPage"),
);
const PersonalHelpPage = lazy(
  () => import("./pages/app/personal/PersonalHelpPage"),
);
const PersonalSettingsPage = lazy(
  () => import("./pages/app/personal/PersonalSettingsPage"),
);
...
const MyBusTripPage = lazy(() => import("./pages/MyBusTripPage"));
...
const ReviewModerationDashboard = lazy(
  () => import("./pages/admin/ReviewModerationDashboard"),
);
...
const EatsRestaurantDashboard = lazy(
  () => import("./pages/EatsRestaurantDashboard"),
);
const EatsDriverDeliveryPage = lazy(
  () => import("./pages/EatsDriverDeliveryPage"),
);
...
const ContactRequestsPage = lazyWithRetry(
  () => import("./pages/chat/ContactRequestsPage"),
);
const MessageRequestsPage = lazyWithRetry(
  () => import("./pages/chat/MessageRequestsPage"),
);
const NearbyChatPage = lazyWithRetry(
  () => import("./pages/chat/NearbyChatPage"),
);
const FindContactsPage = lazyWithRetry(
  () => import("./pages/chat/FindContactsPage"),
);
const FindByUsernamePage = lazyWithRetry(
  () => import("./pages/chat/FindByUsernamePage"),
);
const BlockedUsersPage = lazyWithRetry(
  () => import("./pages/chat/BlockedUsersPage"),
);
const JoinGroupPage = lazyWithRetry(() => import("./pages/chat/JoinGroupPage"));
const PrivacySecurityPage = lazyWithRetry(
  () => import("./pages/chat/settings/PrivacySecurityPage"),
);
const ActiveSessionsPage = lazyWithRetry(
  () => import("./pages/chat/settings/ActiveSessionsPage"),
);
const TwoStepSetupPage = lazyWithRetry(
  () => import("./pages/chat/settings/TwoStepSetupPage"),
);
const PasscodeSetupPage = lazyWithRetry(
  () => import("./pages/chat/settings/PasscodeSetupPage"),
);
const LoginAlertsPage = lazyWithRetry(
  () => import("./pages/chat/settings/LoginAlertsPage"),
);
const ChatPrivacyHubPage = lazyWithRetry(
  () => import("./pages/chat/settings/ChatPrivacyHubPage"),
);
const CustomFoldersPage = lazyWithRetry(
  () => import("./pages/chat/CustomFoldersPage"),
);
const BroadcastListsPage = lazyWithRetry(
  () => import("./pages/chat/BroadcastListsPage"),
);
const NewBroadcastPage = lazyWithRetry(
  () => import("./pages/chat/NewBroadcastPage"),
);
...
const BotDiscoverPage = lazyWithRetry(
  () => import("./pages/chat/BotDiscoverPage"),
);
const BotAdminPage = lazyWithRetry(() => import("./pages/chat/BotAdminPage"));
const BotPublicProfilePage = lazyWithRetry(
  () => import("./pages/BotPublicProfilePage"),
);
const BotCollectionPage = lazyWithRetry(
  () => import("./pages/chat/BotCollectionPage"),
);
const BotInboxPage = lazyWithRetry(() => import("./pages/chat/BotInboxPage"));
const StorageManagerPage = lazyWithRetry(
  () => import("./pages/chat/settings/StorageManagerPage"),
);
const AppLockGate = lazyWithRetry(
  () => import("./components/chat/settings/AppLockGate"),
);
const MfaChallengeDialog = lazy(
  () => import("./components/auth/MfaChallengeDialog"),
);
const GroupCallEntryPage = lazyWithRetry(
  () => import("./pages/chat/GroupCallEntryPage"),
);
const RecordingsPage = lazyWithRetry(
  () => import("./pages/chat/RecordingsPage"),
);
const ChatSearchPage = lazyWithRetry(
  () => import("./pages/chat/ChatSearchPage"),
);
const ChannelsDirectoryPage = lazy(
  () => import("./pages/channels/ChannelsDirectoryPage"),
);
const NewChannelPage = lazy(() => import("./pages/channels/NewChannelPage"));
const ChannelPage = lazy(() => import("./pages/channels/ChannelPage"));
const ManageChannelPage = lazy(
  () => import("./pages/channels/ManageChannelPage"),
);
const ChannelAdminLogPage = lazy(
  () => import("./pages/channels/ChannelAdminLogPage"),
);
const ExplorePage = lazy(() => import("./pages/ExplorePage"));
const BookmarksPage = lazy(() => import("./pages/BookmarksPage"));
const PrivacySettingsPage = lazy(
  () => import("./pages/account/PrivacySettingsPage"),
);
...
const AdminImportShopPage = lazy(
  () => import("./pages/admin/AdminImportShopPage"),
);
...
const AdminContentReportsPage = lazy(
  () => import("./pages/AdminContentReportsPage"),
);
const AdminLaunchDashboard = lazy(
  () => import("./pages/admin/AdminLaunchDashboard"),
);
...
const AccountAnalyticsPage = lazy(
  () => import("./pages/account/AccountAnalyticsPage"),
);
const VerificationRequestPage = lazy(
  () => import("./pages/account/VerificationRequestPage"),
);
const ActivityLogPage = lazy(() => import("./pages/account/ActivityLogPage"));
const AccountExportPage = lazy(
  () => import("./pages/account/AccountExportPage"),
);
...
const GroceryOrderPlaced = lazy(
  () => import("./pages/grocery/GroceryOrderPlaced"),
);
const GroceryOrderConfirmed = lazy(
  () => import("./pages/grocery/GroceryOrderConfirmed"),
);
const GroceryOrderHistory = lazy(() => import("./pages/GroceryOrderHistory"));
const GroceryOrderTracking = lazy(
  () => import("./pages/grocery/GroceryOrderTracking"),
);
...
const ZivoDriverLandingPage = lazy(
  () => import("./pages/driver/ZivoDriverLandingPage"),
);
const DriverShoppingList = lazy(() => import("./pages/DriverShoppingList"));
const DriverOrdersPage = lazy(() => import("./pages/DriverOrdersPage"));
const AdminShoppingOrders = lazy(
  () => import("./pages/admin/AdminShoppingOrders"),
);
const AdminAnalyticsDashboard = lazy(
  () => import("./pages/admin/AdminAnalyticsDashboard"),
);
const AdminFeedDiagnosticsPage = lazy(
  () => import("./pages/admin/AdminFeedDiagnosticsPage"),
);
const AdminNotificationAnalyticsPage = lazy(
  () => import("./pages/admin/AdminNotificationAnalyticsPage"),
);
const AdminStoriesFunnelPage = lazy(
  () => import("./pages/admin/AdminStoriesFunnelPage"),
);
const AdminUsersPage = lazy(() => import("./pages/admin/AdminUsersPage"));
const AdminPricingPage = lazy(() => import("./pages/admin/AdminPricingPage"));
const AdminRemoteConfigPage = lazy(
  () => import("./pages/admin/AdminRemoteConfigPage"),
);
const AdminFlightOrders = lazy(() => import("./pages/admin/AdminFlightOrders"));
const AdminFlightSearchAnalytics = lazy(
  () => import("./pages/admin/AdminFlightSearchAnalytics"),
);
const AdminFlightApiMonitoring = lazy(
  () => import("./pages/admin/AdminFlightApiMonitoring"),
);
const AdminFlightPriceAlerts = lazy(
  () => import("./pages/admin/AdminFlightPriceAlerts"),
);
const AdminStoresPage = lazy(() => import("./pages/admin/AdminStoresPage"));
const AdminStoreEditPage = lazy(
  () => import("./pages/admin/AdminStoreEditPage"),
);
const HotelAdminLaunchPage = lazy(
  () => import("./pages/admin/HotelAdminLaunchPage"),
);
const AdminLodgingQAChecklistPage = lazy(
  () => import("./pages/admin/AdminLodgingQAChecklistPage"),
);
const AdminLodgingCompletionVerificationPage = lazy(
  () => import("./pages/admin/AdminLodgingCompletionVerificationPage"),
);
const AdminBlockedLinksPage = lazy(
  () => import("./pages/admin/AdminBlockedLinksPage"),
);
const AdminThreatHistoryPage = lazy(
  () => import("./pages/admin/AdminThreatHistoryPage"),
);
const AdminCspViolationsPage = lazy(
  () => import("./pages/admin/AdminCspViolationsPage"),
);
const AdminSecurityAuditPage = lazy(
  () => import("./pages/admin/AdminSecurityAuditPage"),
);
const AdminSecurityNotificationsPage = lazy(
  () => import("./pages/admin/AdminSecurityNotificationsPage"),
);
const AdminSecurityOverviewPage = lazy(
  () => import("./pages/admin/AdminSecurityOverviewPage"),
);
const AdminLodgingReservationDetailPage = lazy(
  () => import("./pages/admin/lodging/AdminLodgingReservationDetailPage"),
);
const AdminLodgingWiringCheckPage = lazy(
  () => import("./pages/admin/AdminLodgingWiringCheckPage"),
);
const AdminLodgingWebhookEventsPage = lazy(
  () => import("./pages/admin/AdminLodgingWebhookEventsPage"),
);
const StoreAssetsUploadCheck = lazy(
  () => import("./pages/admin/StoreAssetsUploadCheck"),
);
...
=======
const BusinessPageWizard = lazy(
  () => import("./pages/business/BusinessPageWizard"),
);
const BusinessSoftwareDownloadPage = lazy(
  () => import("./pages/store/BusinessSoftwareDownloadPage"),
);
const AutoRepairDesktopAppPage = lazy(
  () => import("./pages/store/AutoRepairDesktopAppPage"),
);
const ServiceBookingPage = lazy(
  () => import("./pages/store/ServiceBookingPage"),
);
const PublicSalonBookingPage = lazy(
  () => import("./pages/salon/PublicSalonBookingPage"),
);
const PublicCarRentalBookingPage = lazy(
  () => import("./pages/car-rental/PublicCarRentalBookingPage"),
);
const PublicCarRentalBookingDetailPage = lazy(
  () => import("./pages/car-rental/PublicCarRentalBookingDetailPage"),
);
const PublicCarDealershipListingPage = lazy(
  () => import("./pages/car-dealership/PublicCarDealershipListingPage"),
);
const PublicCarDealershipDetailPage = lazy(
  () => import("./pages/car-dealership/PublicCarDealershipDetailPage"),
);
const PublicCarDealershipTestDrivePage = lazy(
  () => import("./pages/car-dealership/PublicCarDealershipTestDrivePage"),
);
const PublicCarDealershipReviewSubmitPage = lazy(
  () => import("./pages/car-dealership/PublicCarDealershipReviewSubmitPage"),
);
const CarRentalDailySheetPage = lazy(
  () => import("./pages/admin/CarRentalDailySheetPage"),
);
const CarRentalReceiptPage = lazy(
  () => import("./pages/admin/CarRentalReceiptPage"),
);
const PublicCarRentalReviewSubmitPage = lazy(
  () => import("./pages/car-rental/PublicCarRentalReviewSubmitPage"),
);
const MyCarRentalsPage = lazy(
  () => import("./pages/car-rental/MyCarRentalsPage"),
);
const PublicCafeOrderPage = lazy(
  () => import("./pages/cafe/PublicCafeOrderPage"),
);
>>>>>>> Stashed changes
const CafeReceiptPage = lazy(() => import("./pages/cafe/CafeReceiptPage"));
const CafeKitchenTicketPage = lazy(
  () => import("./pages/cafe/CafeKitchenTicketPage"),
);
const CafeOrderStatusPage = lazy(
  () => import("./pages/cafe/CafeOrderStatusPage"),
);
const CafeReviewSubmitPage = lazy(
  () => import("./pages/cafe/CafeReviewSubmitPage"),
);
const CafeGiftCardCheckPage = lazy(
  () => import("./pages/cafe/CafeGiftCardCheckPage"),
);
const CafeReservePage = lazy(() => import("./pages/cafe/CafeReservePage"));
const CafeStorefrontPage = lazy(
  () => import("./pages/cafe/CafeStorefrontPage"),
);
const CafeDailySummaryPage = lazy(
  () => import("./pages/admin/CafeDailySummaryPage"),
);
const CafeQrSheetPage = lazy(() => import("./pages/admin/CafeQrSheetPage"));
const PublicSalonBookingDetailPage = lazy(
  () => import("./pages/salon/PublicSalonBookingDetailPage"),
);
const SalonReceiptPage = lazy(() => import("./pages/admin/SalonReceiptPage"));
const SalonDailySchedulePage = lazy(
  () => import("./pages/admin/SalonDailySchedulePage"),
);
const SalonDailySummaryPage = lazy(
  () => import("./pages/admin/SalonDailySummaryPage"),
);
const SalonQueueDisplayPage = lazy(
  () => import("./pages/admin/SalonQueueDisplayPage"),
);
const SalonGiftCardCheckPage = lazy(
  () => import("./pages/salon/SalonGiftCardCheckPage"),
);
const PublicStylistDayPage = lazy(
  () => import("./pages/salon/PublicStylistDayPage"),
);
const PublicStylistEarningsPage = lazy(
  () => import("./pages/salon/PublicStylistEarningsPage"),
);
const PublicSalonMembershipPage = lazy(
  () => import("./pages/salon/PublicSalonMembershipPage"),
);
const PublicSalonCheckinPage = lazy(
  () => import("./pages/salon/PublicSalonCheckinPage"),
);
const PublicReviewSubmitPage = lazy(
  () => import("./pages/salon/PublicReviewSubmitPage"),
);
...
const AdminAppStoreAssets = lazy(
  () => import("./pages/admin/AdminAppStoreAssets"),
);
const AdminAndroidVerification = lazy(
  () => import("./pages/admin/AdminAndroidVerification"),
);
const AdminSupportDashboard = lazy(
  () => import("./pages/admin/AdminSupportDashboard"),
);
const AdminUserAccounts = lazy(() => import("./pages/admin/AdminUserAccounts"));
const AdminGodView = lazy(() => import("./pages/admin/AdminGodView"));
const AdminTelegramSystemPage = lazy(
  () => import("./pages/admin/AdminTelegramSystemPage"),
);
const AdBoostBidding = lazy(() => import("./pages/app/shop/AdBoostBidding"));
const MerchantBoostEngine = lazy(
  () => import("./pages/app/shop/MerchantBoostEngine"),
);
...
const MerchantWalletPage = lazy(
  () => import("./pages/app/shop/MerchantWalletPage"),
);
const MerchantTaxReportPage = lazy(
  () => import("./pages/app/shop/MerchantTaxReportPage"),
);
const AdminChatSecurityPage = lazy(
  () => import("./pages/admin/AdminChatSecurityPage"),
);
const AdminSecuritySentinelPage = lazy(
  () => import("./pages/admin/AdminSecuritySentinelPage"),
);
const AdminAuthShieldPage = lazy(
  () => import("./pages/admin/AdminAuthShieldPage"),
);
...
const DriverPayoutsPage = lazy(
  () => import("./pages/driver/DriverPayoutsPage"),
);
const AdminGoogleAdsPage = lazy(
  () => import("./pages/admin/AdminGoogleAdsPage"),
);
const AdminMetaAdsPage = lazy(() => import("./pages/admin/AdminMetaAdsPage"));
const AdminAdsAnalyticsPage = lazy(
  () => import("./pages/admin/AdminAdsAnalyticsPage"),
);
const AdminMarketingCampaignsPage = lazy(
  () => import("./pages/admin/AdminMarketingCampaignsPage"),
);
...
const AdminFeedbackReplyPage = lazy(
  () => import("./pages/admin/AdminFeedbackReplyPage"),
);
const AdminStoreVerificationPage = lazy(
  () => import("./pages/admin/AdminStoreVerificationPage"),
);
const AdminPartnerApplicationsPage = lazy(
  () => import("./pages/admin/AdminPartnerApplicationsPage"),
);
const AdminFinanceSummaryPage = lazy(
  () => import("./pages/admin/AdminFinanceSummaryPage"),
);
const AdminWebhookStatusPage = lazy(
  () => import("./pages/admin/AdminWebhookStatusPage"),
);
const AdminDriverVerificationPage = lazy(
  () => import("./pages/admin/AdminDriverVerificationPage"),
);
const DriverOnboardingDocumentsPage = lazy(
  () => import("./pages/driver/DriverOnboardingDocumentsPage"),
);
...
const VerifyNewDevice = lazy(() =>
  lazyRetry(() => import("./pages/VerifyNewDevice")),
);
...
const HotelResortDetailPage = lazy(
  () => import("./pages/lodging/HotelResortDetailPage"),
);
const HotelRoomCheckoutPage = lazy(
  () => import("./pages/lodging/HotelRoomCheckoutPage"),
);
const HotelBookingConfirmedPage = lazy(
  () => import("./pages/lodging/HotelBookingConfirmedPage"),
);
const HotelsResortsDirectoryPage = lazy(
  () => import("./pages/lodging/HotelsResortsDirectoryPage"),
);
const HotelsLandingPage = lazy(
  () => import("./pages/lodging/HotelsLandingPage"),
);
...
const CarRentalCheckoutPage = lazy(
  () => import("./pages/cars/CarRentalCheckoutPage"),
);
const CarRentalConfirmedPage = lazy(
  () => import("./pages/cars/CarRentalConfirmedPage"),
);
...
const TravelConfirmationPage = lazy(
  () => import("./pages/TravelConfirmationPage"),
);
const TravelTripsPage = lazy(() => import("./pages/TravelTripsPage"));
const TravelOrderDetailPage = lazy(
  () => import("./pages/TravelOrderDetailPage"),
);
...
const AccessibilityStatement = lazy(
  () => import("./pages/legal/AccessibilityStatement"),
);
const CookiePolicy = lazy(() => import("./pages/legal/CookiePolicy"));
const CancellationPolicy = lazy(
  () => import("./pages/legal/CancellationPolicy"),
);
...
const VulnerabilityDisclosureLegal = lazy(
  () => import("./pages/legal/VulnerabilityDisclosure"),
);
...
const DataRetentionPolicy = lazy(
  () => import("./pages/legal/DataRetentionPolicy"),
);
const DMCACopyrightPolicy = lazy(
  () => import("./pages/legal/DMCACopyrightPolicy"),
);
const DisputeResolution = lazy(() => import("./pages/legal/DisputeResolution"));
const LimitationOfLiability = lazy(
  () => import("./pages/legal/LimitationOfLiability"),
);
const IndemnificationPolicy = lazy(
  () => import("./pages/legal/IndemnificationPolicy"),
);
const AgeRestrictionPolicy = lazy(
  () => import("./pages/legal/AgeRestrictionPolicy"),
);
...
const NoGuaranteeDisclaimer = lazy(
  () => import("./pages/legal/NoGuaranteeDisclaimer"),
);
const GoverningLaw = lazy(() => import("./pages/legal/GoverningLaw"));
const IntellectualProperty = lazy(
  () => import("./pages/legal/IntellectualProperty"),
);
const AccountTermination = lazy(
  () => import("./pages/legal/AccountTermination"),
);
const ThirdPartyLinks = lazy(() => import("./pages/legal/ThirdPartyLinks"));
const CommunicationConsent = lazy(
  () => import("./pages/legal/CommunicationConsent"),
);
const ModificationOfTerms = lazy(
  () => import("./pages/legal/ModificationOfTerms"),
);
const ClassActionWaiver = lazy(() => import("./pages/legal/ClassActionWaiver"));
const AntiMoneyLaundering = lazy(
  () => import("./pages/legal/AntiMoneyLaundering"),
);
...
const WarrantyDisclaimer = lazy(
  () => import("./pages/legal/WarrantyDisclaimer"),
);
...
const TransportationDisclaimer = lazy(
  () => import("./pages/legal/TransportationDisclaimer"),
);
const CarRentalDisclaimer = lazy(
  () => import("./pages/legal/CarRentalDisclaimer"),
);
const InsuranceDisclaimer = lazy(
  () => import("./pages/legal/InsuranceDisclaimer"),
);
...
const NotificationPrefsPage = lazy(
  () => import("./pages/NotificationPrefsPage"),
);
...
const HashtagsDirectoryPage = lazy(
  () => import("./pages/HashtagsDirectoryPage"),
);
...
const ModerationAppealsPage = lazy(
  () => import("./pages/ModerationAppealsPage"),
);
...
const MyChallengeSubmissionsPage = lazy(
  () => import("./pages/MyChallengeSubmissionsPage"),
);
...
const FlightPriceAlertsPage = lazy(
  () => import("./pages/FlightPriceAlertsPage"),
);
...
const MyJobApplicationsPage = lazy(
  () => import("./pages/MyJobApplicationsPage"),
);
const OnboardingProgressPage = lazy(
  () => import("./pages/OnboardingProgressPage"),
);
...
const MutedBlockedUsersPage = lazy(
  () => import("./pages/MutedBlockedUsersPage"),
);
...
const RestaurantReviewDetailsPage = lazy(
  () => import("./pages/RestaurantReviewDetailsPage"),
);
...
const TenantMembershipsPage = lazy(
  () => import("./pages/TenantMembershipsPage"),
);
const RecommendationScoresPage = lazy(
  () => import("./pages/RecommendationScoresPage"),
);
const BusinessRenterAccountPage = lazy(
...
const LegalPoliciesPage = lazy(
  () => import("./pages/account/LegalPoliciesPage"),
);
const ProfileEditPage = lazy(() => import("./pages/account/ProfileEditPage"));
const AccountSecurity = lazy(() => import("./pages/account/AccountSecurity"));
const AccountSessionsPage = lazy(
  () => import("./pages/account/AccountSessionsPage"),
);
const LinkedDevicesPage = lazy(
  () => import("./pages/account/LinkedDevicesPage"),
);
...
const SecretChatPage = lazyWithRetry(
  () => import("./pages/chat/SecretChatPage"),
);
...
const NotificationSettings = lazy(
  () => import("./pages/account/NotificationSettings"),
);
const AccountReferralsPage = lazy(
  () => import("./pages/account/ReferralsPage"),
);
...
const RealtimeMonitoring = lazy(
  () => import("./pages/security/RealtimeMonitoring"),
);
const DataProtection = lazy(() => import("./pages/security/DataProtection"));
const PrivacyCompliance = lazy(
  () => import("./pages/security/PrivacyCompliance"),
);
const TrustCertification = lazy(
  () => import("./pages/security/TrustCertification"),
);
const ScamPrevention = lazy(() => import("./pages/security/ScamPrevention"));
const SecurityOperations = lazy(
  () => import("./pages/security/SecurityOperations"),
);
const DisasterRecovery = lazy(
  () => import("./pages/security/DisasterRecovery"),
);
const VulnerabilityDisclosure = lazy(
  () => import("./pages/security/VulnerabilityDisclosure"),
);
...
const BusinessLandingPage = lazy(
  () => import("./pages/business/BusinessLandingPage"),
);
const BusinessSoftwarePortalPage = lazy(
  () => import("./pages/business/BusinessSoftwarePortalPage"),
);
const BusinessAccountPage = lazy(
  () => import("./pages/business/BusinessAccountPage"),
);
const PartnerAuditDocs = lazy(
  () => import("./pages/business/PartnerAuditDocs"),
);
...
const PartnerOnboarding = lazy(
  () => import("./pages/business/PartnerOnboarding"),
);
...
// Support pages
const TravelBookingsSupport = lazy(
  () => import("./pages/support/TravelBookings"),
);
const SiteIssuesSupport = lazy(() => import("./pages/support/SiteIssues"));
const UserSupportTicketsPage = lazy(
  () => import("./pages/support/UserSupportTicketsPage"),
);
...
const LocalizedFlightRoutePage = lazy(
  () => import("./pages/seo/LocalizedFlightRoutePage"),
);
const CityLandingPage = lazy(() => import("./pages/seo/CityLandingPage"));
const HotelCityLandingPage = lazy(
  () => import("./pages/seo/HotelCityLandingPage"),
);

// Guide pages
const GuidesIndex = lazy(() => import("./pages/guides/GuidesIndex"));
const CheapFlightsGuide = lazy(
  () => import("./pages/guides/CheapFlightsGuide"),
);
...
function shouldRetryQuery(failureCount: number, error: unknown) {
  ...
  if (
    status !== null &&
    [400, 401, 403, 404, 409, 410, 412, 422].includes(status)
  ) {
    return false;
  }
...
function shouldRetryMutation(failureCount: number, error: unknown) {
  ...
  return (
    (info.type === "network" || info.type === "rate_limit" || status === 429) &&
    failureCount < 2
  );
}
...
const PageLoader = forwardRef<HTMLDivElement>(function PageLoader(_, ref) {
  ...
  const isFeedLikeRoute =
    pathname.startsWith("/feed") || pathname.startsWith("/reels");
        ...
        <div className="mx-auto w-full max-w-2xl px-3 pt-4">
          ...
          <div className="flex gap-3 mb-4 overflow-hidden">
            {[0, 1, 2, 3, 4, 5].map((i) => (
              <div
                key={i}
                className="h-14 w-14 rounded-full bg-muted/50 animate-pulse shrink-0"
              />
            ))}
          </div>
          <div className="flex gap-2 mb-3">
            {[0, 1, 2, 3].map((i) => (
              <div
                key={i}
                className="h-7 w-16 rounded-full bg-muted/40 animate-pulse"
              />
            ))}
          </div>
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="text-sm font-semibold tracking-[0.18em] text-ig-gradient">
          ZIVO
        </p>
      </div>
    </div>
...
const GeofenceBootstrap = lazy(() =>
  import("@/hooks/useGeofenceNotifications").then((m) => {
    function GeofenceComp() {
      m.useGeofenceNotifications();
      return null;
    }
...
const DeletionReturnDialog = lazy(
  () => import("@/components/account/DeletionReturnDialog"),
);
...
function isCurrentZivoChatHost() {
  return (
    typeof window !== "undefined" && isZivoChatHost(window.location.hostname)
  );
}
...
function isCurrentZivoDriverHost() {
  return (
    typeof window !== "undefined" && isZivoDriverHost(window.location.hostname)
  );
}
...
function isCurrentZivoBusinessHost() {
  return (
    typeof window !== "undefined" &&
    isZivoBusinessHost(window.location.hostname)
  );
}
...
function isCurrentZivoEmployeeHost() {
  return (
    typeof window !== "undefined" &&
    isZivoEmployeeHost(window.location.hostname)
  );
}
...
const PAYMENT_RETURN_MARKER_RE =
  /(?:^|[?&])(?:paypal_return|paypal_cancel|square_return|eats_paypal_return|eats_paypal_cancel|eats_square_return|grocery_paypal_return|grocery_paypal_cancel|grocery_square_return)=/;
...
function DirectThreadRedirect() {
  ...
  return (
    <Navigate to={`/chat${query ? `?${query}` : ""}${location.hash}`} replace />
  );
}
...
function ZivoSoftwareHostGate() {
  ...
  const isAutoRepairPath =
    ...
    isZivoSoftwareWorkspacePath(pathname);
  ...
  if (pathname === "/business/dashboard") {
    return (
      <Navigate
        to={`${ZIVO_SOFTWARE_AUTH_REDIRECT_PATH}${location.search}${location.hash}`}
        replace
      />
    );
  }
...
=======
  if (
    isAuthPath ||
    isLegalPath ||
    isSoftwareBusinessPath ||
    isAutoRepairPath ||
    isSoftwareDashboardPath ||
    isOperationalAsset
  ) {
>>>>>>> Stashed changes
    return null;
...
function ZivoChatHostGate() {
  ...
  if (
    typeof window === "undefined" ||
    !isZivoChatHost(window.location.hostname)
  ) {
    return null;
  }
  ...
  const isAccountPath = accountPaths.some(
    (path) => pathname === path || pathname.startsWith(`${path}/`),
  );
  const isLegalPath =
    pathname === "/legal/terms" ||
...
function ZivoDriverHostGate() {
  ...
  if (
    typeof window === "undefined" ||
    !isZivoDriverHost(window.location.hostname)
  ) {
    return null;
  }
                ...
                >
                  ...
                  <AuthProvider>
                            ...
                            <UTMProvider>
                              <Suspense fallback={<PageLoader />}>
                                <Routes>
                                  <Route
                                    ...
                                    element={
                                      isCurrentZivoTravelHost() ? (
                                        ...
                                        <ZivoDriverLandingPage />
                                      ) : isCurrentZivoBusinessHost() ? (
                                        <ZivoBusinessHome />
                                      ) : isCurrentZivoEmployeeHost() ? (
                                        <ZivoEmployeeHome />
                                      ) : (
                                        <Index />
                                      )
                                  ...
                                  <Route
                                    path="/zivo-travel"
                                    element={<ZivoTravelHome />}
                                  />
                                  {/* Travel utility pages — host-agnostic preview paths (also usable on the travel host). */}
                                  <Route
                                    path="/zivo-travel/my-trips"
                                    element={<ZivoTravelMyTrips />}
                                  />
                                  <Route
                                    path="/zivo-travel/wallet"
                                    element={<ZivoTravelWallet />}
                                  />
                                  <Route
                                    path="/zivo-travel/payment-methods"
                                    element={<ZivoTravelPaymentMethods />}
                                  />
                                  <Route
                                    path="/zivo-travel/account"
                                    element={<ZivoTravelAccount />}
                                  />

                                  <Route path="/login" element={<Login />} />
                                  <Route path="/signup" element={<Signup />} />
                                  <Route
                                    path="/prototype/ecosystem"
                                    element={<EcosystemPrototype />}
                                  />
                                  <Route
                                    path="/unsubscribe"
                                    element={<Unsubscribe />}
                                  ...
                                  />
                                  <Route
                                    path="/connect/software"
                                    element={<ConnectSoftware />}
                                  />
                                  <Route
                                    path="/connect/media"
                                    element={<ConnectMedia />}
                                  />
                                  <Route
                                    path="/d/:token"
                                  ...
                                  <Route
                                    ...
                                    element={
                                      <ProtectedRoute>
                                        <PreserveQueryRedirect to="/wallet" />
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                   ...
                   Do NOT re-add an /more route here — it would shadow MorePage. */}
                                  ...
                                  />
                                  <Route
                                    path="/personal/employer/jobs/:id/applicants"
                                    element={
                                      <ProtectedRoute>
                                        <JobApplicantsPage />
                                      </ProtectedRoute>
                                  ...
                                  />
                                  <Route
                                    path="/personal/timesheet"
                                    element={
                                      <ProtectedRoute>
                                        <PersonalTimesheetPage />
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                    path="/personal/pay-stubs"
                                    element={
                                      <ProtectedRoute>
                                        <PersonalPayStubsPage />
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                  ...
                                  />
                                  <Route
                                    path="/shop-dashboard/employees/:id"
                                    element={
                                      <ProtectedRoute>
                                        <ShopEmployeeDetailPage />
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                  ...
                                  <Route
                                    ...
                                    element={
                                      <ProtectedRoute>
                                        <ShopEmployeeSchedulePage />
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                    path="/shop-dashboard/time-clock"
                                    element={
                                      <ProtectedRoute>
                                        <ShopTimeClockPage />
                                      </ProtectedRoute>
                                  ...
                                  />
                                  <Route
                                    path="/shop-dashboard/employee-rules"
                                    element={
                                      <ProtectedRoute>
                                        <ShopEmployeeRulesPage />
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                    path="/shop-dashboard/attendance"
                                    element={
                                      <ProtectedRoute>
                                        <ShopAttendancePage />
                                      </ProtectedRoute>
                                  ...
                                  />
                                  <Route
                                    path="/shop-dashboard/performance"
                                    element={
                                      <ProtectedRoute>
                                        <ShopPerformancePage />
                                      </ProtectedRoute>
                                  ...
                                  />
                                  <Route
                                    path="/shop-dashboard/attribution"
                                    element={
                                      <ProtectedRoute>
                                        <SalesAttributionPage />
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                    path="/shop-dashboard/sandbox"
                                    element={
                                      <ProtectedRoute>
                                        <SandboxModePage />
                                      </ProtectedRoute>
                                  ...
                                  />
                                  <Route
                                    path="/shop-dashboard/roi"
                                    element={
                                      <ProtectedRoute>
                                        <MerchantROIDashboard />
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                    path="/shop-dashboard/refer"
                                    element={
                                      <ProtectedRoute>
                                        <ReferAShopPage />
                                      </ProtectedRoute>
                                  ...
                                  <Route
                                    path="/book-flight"
                                    element={
                                      <PreserveQueryRedirect to="/flights" />
                                    }
                                  />
                                  <Route
                                    path="/book-hotel"
                                    element={
                                      <PreserveQueryRedirect to="/hotels" />
                                    }
                                  />
                                  <Route
                                    path="/travel-extras"
                                    element={
                                      <PreserveQueryRedirect to="/extras" />
                                    }
                                  />
                                  <Route
                                    path="/rides"
                                    element={
                                      <PreserveQueryRedirect to="/rides/hub" />
                                    }
                                  />
                                  <Route
                                    path="/rides/track/:tripId"
                                    element={
                                      <ProtectedRoute>
                                        <PhoneRequiredGate>
                                          <CambodiaOnlyGate>
                                  ...
                                  />
                                  <Route
                                    path="/eats/reserve/:restaurantId"
                                    element={
                                      <ProtectedRoute>
                                        <PhoneRequiredGate>
                                          <ReservationPage />
                                  ...
                                  <Route
                                    ...
                                    element={
                                      <AdminShellRoute
                                        vertical="restaurant"
                                        title="Restaurant Dashboard | ZIVO Admin"
                                      >
                                  ...
                                  />
                                  <Route
                                    path="/my-trips-legacy"
                                    element={
                                      <PreserveQueryRedirect to="/trips" />
                                    }
                                  />
                                  <Route
                                    path="/account"
                                    element={
                                      isCurrentZivoTravelHost() ? (
                                        ...
                                        <PreserveQueryRedirect to="/profile" />
                                      )
                                    }
                                  />
                                  <Route
                                    path="/alerts"
                                    element={
                                      <PreserveQueryRedirect to="/notifications" />
                                    }
                                  />
                                  <Route
                                    path="/delivery"
                                  ...
                                  <Route
                                    ...
                                    element={<InspectionViewPage />}
                                  />
                                  <Route
                                    path={SOCIAL_ROUTE_PATHS.reelDetail}
                                    element={<FeedPage />}
                                  />
                                  <Route
                                    path="/sound/:soundName"
                                    element={<SoundPage />}
                                  />
                                  <Route
                                    path="/dl/:kind/:id"
                                    element={<DeepLinkLandingPage />}
                                  />
                                  <Route
                                    path="/stories/:storyId"
                                    element={<StoryDeepLinkPage />}
                                  />
                                  <Route
                                    path="/shop/:storeId"
                                  ...
                                  />
                                  <Route
                                    path="/direct/t/:partnerId"
                                    element={
                                      <ProtectedRoute>
                                        <DirectThreadRedirect />
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                  ...
                                  />
                                  <Route
                                    path="/chat/bots/collections/:slug"
                                    element={
                                      <ProtectedRoute>
                                        <BotCollectionPage />
                                      </ProtectedRoute>
                                  ...
                                  />
                                  <Route
                                    path="/chat/settings/login-alerts"
                                    element={
                                      <ProtectedRoute>
                                        <LoginAlertsPage />
                                      </ProtectedRoute>
                                  ...
                                  />
                                  <Route
                                    path="/chat/settings/privacy-hub"
                                    element={
                                      <ProtectedRoute>
                                        <ChatPrivacyHubPage />
                                      </ProtectedRoute>
                                  ...
                                  <Route
                                    path="/admin"
                                    element={
                                      <Navigate to="/admin/god-view" replace />
                                    }
                                  />
                                  <Route
                                    path="/admin/shop"
...
=======
                                  ...
                                  />
                                  <Route
                                    path="/salon/:slug/membership"
                                    element={<PublicSalonMembershipPage />}
                                  />
                                  <Route
                                    path="/salon/:slug/check-in"
                                    element={<PublicSalonCheckinPage />}
                                  />
                                  <Route
                                    path="/salon/:slug"
                                    element={<PublicSalonBookingPage />}
                                  />
                                  <Route
                                    path="/car-rental/:slug"
                                    element={<PublicCarRentalBookingPage />}
                                  />
                                  {/* More-specific routes first so React Router matches /v/:vehicleId
                    and /review/:dealId before /:slug. */}
                                  <Route
                                    ...
                                    element={
                                      <PublicCarDealershipTestDrivePage />
                                    }
                                  />
                                  <Route
                                    path="/car-dealership/:slug/v/:vehicleId"
                                    element={<PublicCarDealershipDetailPage />}
                                  />
                                  <Route
                                    path="/car-dealership/:slug/review/:dealId"
                                    element={
                                      <PublicCarDealershipReviewSubmitPage />
                                    }
                                  />
                                  <Route
                                    path="/car-dealership/:slug"
                                    element={<PublicCarDealershipListingPage />}
                                  />
                                  <Route
                                  ...
                                  />
                                  <Route
                                    path="/car-rental-booking/:code"
                                    element={
                                      <PublicCarRentalBookingDetailPage />
                                    }
                                  />
                                  <Route
                                    path="/admin/stores/:storeId/car-rental-daily-sheet"
                                    element={<CarRentalDailySheetPage />}
                                  />
                                  <Route
                                    path="/admin/stores/:storeId/car-rental-receipt/:reservationId"
                                    element={<CarRentalReceiptPage />}
                                  />
                                  <Route
                                    path="/car-rental-review/:reservationId"
                                    element={
                                      <PublicCarRentalReviewSubmitPage />
                                    }
                                  />
                                  <Route
                                    path="/my-rentals"
                                    element={<MyCarRentalsPage />}
                                  />
                                  <Route
                                    path="/cafe/:slug/gift-card-check"
                                    element={<CafeGiftCardCheckPage />}
                                  />
                                  <Route
                                    path="/cafe/:slug/about"
                                    element={<CafeStorefrontPage />}
                                  />
                                  <Route
                                    path="/cafe/:slug/reserve"
                                    element={<CafeReservePage />}
                                  />
                                  <Route
                                    path="/cafe/:slug"
                                    element={<PublicCafeOrderPage />}
                                  />
                                  <Route
                                    path="/cafe/receipt/:orderId"
                                    element={<CafeReceiptPage />}
                                  />
                                  <Route
                                    path="/cafe/kitchen-ticket/:orderId"
                                    element={<CafeKitchenTicketPage />}
                                  />
                                  <Route
                                    path="/cafe/order/:orderId"
                                    element={<CafeOrderStatusPage />}
                                  />
                                  <Route
                                    path="/cafe/review/:orderId"
                                    element={<CafeReviewSubmitPage />}
                                  />
                                  <Route
                                    path="/admin/cafe-summary/:storeId/:date"
                                    element={<CafeDailySummaryPage />}
                                  />
                                  <Route
                                    path="/admin/cafe-qr-sheet/:storeId"
                                    element={<CafeQrSheetPage />}
                                  />
                                  <Route
                                    path="/booking/:id"
                                    element={<PublicSalonBookingDetailPage />}
                                  />
                                  <Route
                                    path="/admin/salon-receipt/:bookingId"
                                    element={<SalonReceiptPage />}
                                  />
                                  <Route
                                    path="/admin/salon-schedule/:storeId/:date"
                                    element={<SalonDailySchedulePage />}
                                  />
                                  <Route
                                    path="/admin/salon-summary/:storeId/:date"
                                    element={<SalonDailySummaryPage />}
                                  />
                                  <Route
                                    path="/admin/salon-queue/:storeId"
                                    element={<SalonQueueDisplayPage />}
                                  />
                                  <Route
                                    path="/gift-card"
                                    element={<SalonGiftCardCheckPage />}
                                  />
                                  <Route
                                    path="/stylist/:stylistId/earnings"
                                    element={<PublicStylistEarningsPage />}
                                  />
                                  <Route
                                    path="/stylist/:stylistId"
                                    element={<PublicStylistDayPage />}
                                  />
                                  <Route
                                    path="/review/:bookingId"
                                    element={<PublicReviewSubmitPage />}
                                  />
                                  <Route
                                    path="/grocery/store/:slug"
                                    element={<GroceryStorePage />}
                                  />
                                  <Route
                                    path="/grocery/shop/:slug"
                                    element={<StoreProfilePage />}
                                  />
                                  <Route
                                    path="/store/:slug"
                                  ...
                                  />
                                  <Route
                                    path="/grocery/order-placed"
                                    element={<GroceryOrderPlaced />}
                                  />
                                  <Route
                                    path="/grocery/order-confirmed"
                                    element={<GroceryOrderConfirmed />}
                                  />
                                  <Route
                                    path="/grocery/orders"
                                    element={<GroceryOrderHistory />}
                                  />
                                  <Route
                                    path="/grocery/track/:orderId"
                                    element={<GroceryOrderTracking />}
                                  />
                                  <Route
                                    path="/grocery/terms"
                                    element={<GroceryTerms />}
                                  />
                                  <Route
                                    path="/grocery/returns"
                                    element={<GroceryReturns />}
                                  />
                                  <Route
                                    path="/grocery/fees"
                                    element={<GroceryFees />}
                                  ...
                                  />
                                  <Route
                                    path="/driver/shopping/:orderId"
                                    element={<DriverShoppingList />}
                                  />
                                  <Route
                                    path="/driver/shop/:orderId"
                                    element={<DriverShopPage />}
                                  />
                                  <Route
                                    path="/driver/home"
                                  ...
                                  <Route
                                    ...
                                    element={
                                      <ProtectedRoute>
                                        <DriverOnboardingDocumentsPage />
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                    path="/admin/ads/google"
                                    element={
                                      <ProtectedRoute requireAdmin={true}>
                                        <AdminGoogleAdsPage />
                                      </ProtectedRoute>
                                  ...
                                  />
                                  <Route
                                    path="/admin/marketing/broadcast"
                                    element={
                                      <ProtectedRoute requireAdmin={true}>
                                        <AdminBroadcastPage />
                                      </ProtectedRoute>
                                  ...
                                  />
                                  <Route
                                    path="/admin/operations/heatmap"
                                    element={
                                      <ProtectedRoute requireAdmin={true}>
                                        <AdminTripHeatmapPage />
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                  ...
                                  <Route
                                    ...
                                    element={
                                      <PreserveQueryRedirect to="/delivery" />
                                    }
                                  />
                                  <Route
                                  ...
                                  />
                                  <Route
                                    path="/admin/stories-funnel"
                                    element={
                                      <ProtectedRoute requireAdmin={true}>
                                        <AdminStoriesFunnelPage />
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                  ...
                                  <Route
                                    ...
                                    element={
                                      <ProtectedRoute requireAdmin={true}>
                                        <AdminRemoteConfigPage />
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                    path="/admin/flight-orders"
                                    element={
                                      <ProtectedRoute requireAdmin={true}>
                                        <AdminFlightOrders />
                                      </ProtectedRoute>
                                  ...
                                  />
                                  <Route
                                    path="/admin/stores/:storeId/upload-check"
                                    element={
                                      <ProtectedRoute requireAdmin={true}>
                                        <StoreAssetsUploadCheck />
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                    path="/admin/stores/:storeId/lodging/reservations/:reservationId"
                                    element={
                                      <ProtectedRoute requireAdmin={true}>
                                  ...
                                  <Route
                                    ...
                                    element={
                                      <ProtectedRoute requireAdmin={true}>
                                        <AdminLodgingCompletionVerificationPage />
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                  ...
                                  <Route
                                    ...
                                    element={
                                      <ProtectedRoute requireAdmin={true}>
                                        <AdminSecurityNotificationsPage />
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                  ...
                                  />
                                  <Route
                                    path="/business/software/:storeId"
                                    element={
                                      <ProtectedRoute>
                                        <BusinessSoftwareDownloadPage />
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                    path="/desktop/auto-repair/:storeId"
                                    element={
                                      <ProtectedRoute
                                        requireAdmin={true}
                                        allowStoreOwner={true}
                                      >
                                        <AutoRepairDesktopAppPage />
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                  ...
                                  />
                                  <Route
                                    path="/shop-dashboard/boost-engine"
                                    element={
                                      <ProtectedRoute>
                                        <MerchantBoostEngine />
                                      </ProtectedRoute>
                                  ...
                                  />
                                  <Route
                                    path="/shop-dashboard/ai-creative"
                                    element={
                                      <ProtectedRoute>
                                        <AiCreativeSuite />
                                      </ProtectedRoute>
                                  ...
                                  />
                                  <Route
                                    path="/shop-dashboard/ai-content"
                                    element={
                                      <ProtectedRoute>
                                        <AiContentSuite />
                                      </ProtectedRoute>
                                  ...
                                  />
                                  <Route
                                    path="/shop-dashboard/tax-reports"
                                    element={
                                      <ProtectedRoute>
                                        <MerchantTaxReportPage />
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                  ...
                                  />
                                  <Route
                                    path="/admin/telegram-system"
                                    element={
                                      <ProtectedRoute requireAdmin={true}>
                                        <AdminTelegramSystemPage />
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                  ...
                                  <Route
                                    ...
                                    element={
                                      <ProtectedRoute requireAdmin={true}>
                                        <AdminSecuritySentinelPage />
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                    path="/admin/auth-shield"
                                    element={
                                      <ProtectedRoute requireAdmin={true}>
                                        <AdminAuthShieldPage />
                                      </ProtectedRoute>
                                  ...
                                  <Route
                                    path="/events"
                                    element={
                                      <PreserveQueryRedirect to="/things-to-do" />
                                    }
                                  />
                                  <Route
                                    path="/ground-transport"
                                    element={
                                      <PreserveQueryRedirect to="/car-rental" />
                                    }
                                  />
                                  <Route
                                    path="/insurance"
                                    element={
                                      <PreserveQueryRedirect to="/travel-insurance" />
                                    }
                                  />
>>>>>>> Stashed changes
                                  ...
                                  <Route
                                    path="/flights"
                                    element={
                                      <RouteErrorBoundary section="Flights">
                                        <FlightLanding />
                                      </RouteErrorBoundary>
                                    }
                                  />
                                  ...
                                  />
                                  <Route
                                    path="/flights/:origin-to-:destination"
                                    element={
                                      <RouteErrorBoundary section="Flights">
                                        <FlightRoutePage />
                                      </RouteErrorBoundary>
                                  ...
                                  <Route
                                    path="/hotels/:city"
                                    element={
                                      <RouteErrorBoundary section="Hotels">
                                        <ZivoTravelHotelGate>
                                          <HotelCityLandingPage />
                                        </ZivoTravelHotelGate>
                                      </RouteErrorBoundary>
                                    }
                                  />
                                  <Route
                                    path="/hotel/:storeId"
                                    element={
                                      <RouteErrorBoundary section="HotelDetail">
                                        <ZivoTravelHotelGate>
                                  ...
                                  />
                                  <Route
                                    path="/hotel/:storeId/book"
                                    element={
                                      <ProtectedRoute>
                                        <RouteErrorBoundary section="HotelCheckout">
                                          <ZivoTravelHotelGate>
                                            <HotelRoomCheckoutPage />
                                          </ZivoTravelHotelGate>
                                        </RouteErrorBoundary>
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                    path="/hotel/:storeId/booking-confirmed"
                                    element={
                                      <ProtectedRoute>
                                        <RouteErrorBoundary section="HotelBookingConfirmed">
                                          <ZivoTravelHotelGate>
                                            <HotelBookingConfirmedPage />
                                          </ZivoTravelHotelGate>
                                        </RouteErrorBoundary>
                                      </ProtectedRoute>
                                    }
                                  ...
                                  <Route
                                    path="/hotels"
                                    element={
                                      <RouteErrorBoundary section="HotelsLanding">
                                        <ZivoTravelHotelGate>
                                          <HotelsLandingPage />
                                        </ZivoTravelHotelGate>
                                      </RouteErrorBoundary>
                                  ...
                                  <Route
                                    path="/hotels-list"
                                    element={
                                      <RouteErrorBoundary section="HotelsDirectory">
                                        <ZivoTravelHotelGate>
                                  ...
                                  <Route
                                    path="/bus"
                                    element={
                                      <RouteErrorBoundary section="Bus">
                                        <BusBookingPage />
                                      </RouteErrorBoundary>
                                    }
                                  />
                                  ...
                                  <Route
                                    path="/car-rental"
                                    element={
                                      <RouteErrorBoundary section="Cars">
                                        <CarRentalLanding />
                                      </RouteErrorBoundary>
                                    }
                                  />
                                  <Route
                                    path="/car-rental/in-:location"
                                    element={
                                      <RouteErrorBoundary section="Cars">
                                        <CarRentalLanding />
                                      </RouteErrorBoundary>
                                  ...
                                  <Route
                                    ...
                                    element={
                                      <ProtectedRoute>
                                        <RouteErrorBoundary section="Cars">
                                          <CarRentalCheckoutPage />
                                        </RouteErrorBoundary>
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                    path="/cars/:id/booking-confirmed"
                                    element={
                                      <RouteErrorBoundary section="Cars">
                                        <CarRentalConfirmedPage />
                                      </RouteErrorBoundary>
                                    }
                                  />
                                  <Route
                                  ...
                                  />
                                  <Route
                                    path="/my-trips/lodging/:reservationId"
                                    element={
                                      <ProtectedRoute>
                                        <RouteErrorBoundary section="Lodging">
                                          <MyLodgingTripPage />
                                        </RouteErrorBoundary>
                                      </ProtectedRoute>
                                    }
                                  ...
                                  />
                                  <Route
                                    path="/my-trips/flights/:bookingId"
                                    element={
                                      <ProtectedRoute>
                                        <RouteErrorBoundary section="Flights">
                                          <MyFlightTripPage />
                                  ...
                                  />
                                  <Route
                                    path="/my-trips/hotels/:bookingId"
                                    element={
                                      <ProtectedRoute>
                                        <RouteErrorBoundary section="Hotels">
                                          <MyHotelTripPage />
                                  ...
                                  />
                                  <Route
                                    path="/my-trips/restaurants/:bookingId"
                                    element={
                                      <ProtectedRoute>
                                        <RouteErrorBoundary section="Restaurants">
                                          <MyRestaurantTripPage />
                                        </RouteErrorBoundary>
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                    path="/my-trips/activities/:bookingId"
                                    element={
                                      <ProtectedRoute>
                                        <RouteErrorBoundary section="Activities">
                                          <MyActivityTripPage />
                                        </RouteErrorBoundary>
                                      </ProtectedRoute>
                                    }
                                  ...
                                  />
                                  <Route
                                    path="/auth/zivosmedia/authorize"
                                    element={<ZivosmediaAuthorize />}
                                  />
                                  <Route
                                    path="/onboarding"
                                    element={<Onboarding />}
                                  ...
                                  <Route
                                    ...
                                    element={<VerifyNewDevice />}
                                  />
                                  <Route path="/setup" element={<Setup />} />

                                  <Route
                                    path={SOCIAL_ROUTE_PATHS.profile}
                                    element={
                                      <GuestOrUser
                                        guestPreview={<GuestProfilePreview />}
                                      >
                                        <Profile />
                                      </GuestOrUser>
                                    }
                                  ...
                                  <Route
                                    path="/voice-rooms"
                                    element={<VoiceRoomsHubPage />}
                                  />
                                  <Route
                                    path="/fitness"
                                    element={<FitnessHubPage />}
                                  />
                                  <Route
                                    path="/events-hub/create"
                                  ...
                                  />
                                  <Route
                                    path="/account/gift-cards/success"
                                    element={
                                      <ProtectedRoute>
                                        <GiftCardSuccessPage />
                                      </ProtectedRoute>
                                  ...
                                  <Route
                                    path="/hashtags"
                                    element={<HashtagsDirectoryPage />}
                                  />
                                  <Route
                                    path="/gifs"
                                    element={<GifLibraryPage />}
                                  />
                                  <Route
                                    path="/split-bills"
                                    element={
                                  ...
                                  />
                                  <Route
                                    path="/flight-price-alerts"
                                    element={
                                      <ProtectedRoute>
                                        <FlightPriceAlertsPage />
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                  ...
                                  <Route
                                    path="/store-promos"
                                    element={<StorePromoCodesPage />}
                                  />
                                  <Route
                                    path="/emoji-packs"
                                    element={<EmojiPacksPage />}
                                  />
                                  <Route
                                    path="/live-chat-sessions"
                                    element={
                                      <ProtectedRoute>
                                        <LiveChatSessionsPage />
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                  ...
                                  <Route
                                    path="/music-stickers"
                                    element={<MusicStickersPage />}
                                  />
                                  <Route
                                    path="/avatar-moods"
                                    element={<AvatarMoodsPage />}
                                  />
                                  <Route
                                    path="/downloaded-packs"
                                    element={
                                      <ProtectedRoute>
                                        <DownloadedPacksPage />
                                      </ProtectedRoute>
                                  ...
                                  />
                                  <Route
                                    path="/recommendation-scores"
                                    element={
                                      <ProtectedRoute>
                                        <RecommendationScoresPage />
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                  ...
                                  <Route
                                    ...
                                    element={
                                      <Navigate
                                        to="/account/data-rights#cookies"
                                        replace
                                      />
                                    }
                                  />
                                  <Route
                                    path="/account/translation"
                                    element={
                                      <Navigate
                                        to="/account/preferences#translation"
                                        replace
                                      />
                                    }
                                  />
                                  ...
                                  />
                                  <Route
                                    path="/legal/security-incident"
                                    element={<SecurityIncident />}
                                  />
                                  <Route
                                    path="/legal/security"
                                  ...
                                  <Route
                                    path="/legal/vdp"
                                    element={<VulnerabilityDisclosureLegal />}
                                  />
                                  <Route
                                    path="/legal/seller-of-travel"
                                    element={<SellerOfTravel />}
                                  />
                                  <Route
                                    path="/legal/flight-terms"
                                    element={<FlightTerms />}
                                  />
                                  <Route
                                    path="/legal/social-media-policy"
                                    element={<SocialMediaPolicy />}
                                  />
                                  <Route
                                  ...
                                  />
                                  <Route
                                    path="/legal/limitation-of-liability"
                                    element={<LimitationOfLiability />}
                                  />
                                  <Route
                                    path="/legal/indemnification"
                                    element={<IndemnificationPolicy />}
                                  />
                                  <Route
                                    path="/legal/age-restriction"
                                    element={<AgeRestrictionPolicy />}
                                  />
                                  <Route
                                    path="/legal/assumption-of-risk"
                                    element={<AssumptionOfRisk />}
                                  />
                                  <Route
                                  ...
                                  />
                                  <Route
                                    path="/legal/force-majeure"
                                    element={<ForceMajeure />}
                                  />
                                  <Route
                                    path="/legal/no-guarantee"
                                    element={<NoGuaranteeDisclaimer />}
                                  />
                                  <Route
                                    path="/legal/governing-law"
                                    element={<GoverningLaw />}
                                  />
                                  <Route
                                  ...
                                  />
                                  <Route
                                    path="/legal/account-termination"
                                    element={<AccountTermination />}
                                  />
                                  <Route
                                    path="/legal/third-party-links"
                                    element={<ThirdPartyLinks />}
                                  />
                                  <Route
                                    path="/legal/communication-consent"
                                    element={<CommunicationConsent />}
                                  />
                                  <Route
                                    path="/legal/modification-of-terms"
                                    element={<ModificationOfTerms />}
                                  />
                                  <Route
                                    path="/legal/class-action-waiver"
                                    element={<ClassActionWaiver />}
                                  />
                                  <Route
                                    path="/legal/anti-money-laundering"
                                    element={<AntiMoneyLaundering />}
                                  />
                                  <Route
                                    path="/legal/user-conduct"
                                    element={<UserConduct />}
                                  />
                                  <Route
                                    path="/legal/california-privacy"
                                    element={<CaliforniaPrivacy />}
                                  />
                                  <Route
                                    path="/legal/fraud-prevention"
                                    element={<FraudPrevention />}
                                  />
                                  <Route
                                    path="/legal/warranty-disclaimer"
                                  ...
                                  />
                                  <Route
                                    path="/legal/transportation-disclaimer"
                                    element={<TransportationDisclaimer />}
                                  />
                                  <Route
                                    path="/legal/car-rental-disclaimer"
                                    element={<CarRentalDisclaimer />}
                                  />
                                  <Route
                                    path="/legal/insurance-disclaimer"
                                  ...
                                  />
                                  <Route
                                    path="/legal/meta-privacy"
                                    element={<MetaPrivacyDisclosure />}
                                  />
                                  <Route
                                    path="/legal/insurance-disclosure"
                                    element={<InsuranceDisclosure />}
                                  />
                                  <Route
                    ...
                    on, and /refunds is the more guessable URL of the two. */}
                                  <Route
                                    path="/terms"
                                    element={
                                      <Navigate to="/legal/terms" replace />
                                    }
                                  />
                                  <Route
                                    path="/refunds"
                                    element={
                                      <Navigate to="/legal/refunds" replace />
                                    }
                                  />
                                  <Route
                                    path="/company"
                                  ...
                                  />
                                  <Route
                                    path="/multi-city-builder"
                                    element={<MultiCityBuilder />}
                                  />
                                  ...
                                  <Route
                                    ...
                                    element={<CarRentalCityPage />}
                                  />
                                  <Route
                                    path="/destinations/:city/activities"
                                    element={<DestinationActivitiesPage />}
                                  />
                                  <Route
                                    path="/destinations/:city/hotels"
                                    element={<DestinationHotelsPage />}
                                  />

                                  {/* Grocery + service flows — /grocery canonical route (GroceryMarketplace) defined above */}
                                  <Route
                                    path="/services/new-order"
                                    element={
                                      <ProtectedRoute>
                                        <NewServiceOrderPage />
                                      </ProtectedRoute>
                                  ...
                                  />
                                  <Route
                                    path="/enterprise-trust"
                                    element={<EnterpriseTrust />}
                                  />
                                  <Route
                                    path="/partner-audit-docs"
                                    element={<PartnerAuditDocs />}
                                  />
                                  <Route
                                    path="/reliability"
                                    element={<Reliability />}
                                  ...
                                  <Route
                                    path="/deals/:slug"
                                    element={<SeasonalDealPage />}
                                  />
                                  <Route
                                    path="/brand"
                                    element={<BrandMission />}
                                  />
                                  <Route
                                    path="/mission"
                                    element={<BrandMission />}
                                  ...
                                  <Route
                                    path="/trust-statement"
                                    element={<TrustStatement />}
                                  />
                                  ...
                                  <Route
                                    ...
                                    element={<ZeroTrustPolicy />}
                                  />
                                  <Route
                                    path="/security/scale-protection"
                                    element={<ScaleProtection />}
                                  />
                                  <Route
                                  ...
                                  />
                                  <Route
                                    path="/security/privacy-compliance"
                                    element={<PrivacyCompliance />}
                                  />
                                  <Route
                                    path="/security/trust"
                                    element={<TrustCertification />}
                                  />
                                  <Route
                                    path="/security/scams"
                                  ...
                                  />
                                  <Route
                                    path="/security/vulnerability-disclosure"
                                  ...
                                  {/* Business */}
                                  <Route
                                    path="/partner-with-zivo"
                                    element={<PartnerOnboardingDispatcher />}
                                  />
                                  <Route
                                    path="/become-partner"
                                  ...
                                  <Route
                                    path="/partners/join"
                                    element={
                                      <PreserveQueryRedirect to="/become-partner" />
                                    }
                                  />
                                  <Route
                                    path="/network"
                                    element={<NetworkPlacesPage />}
                                  />
                                  <Route
                                    path="/places"
                                    element={
                                      <PreserveQueryRedirect to="/network" />
                                    }
                                  />
                                  <Route
                                    path="/network/saved"
                                    element={<SavedFavoritesPage />}
                                  />
                                  <Route
                                    path="/favorites/network"
                                    element={
                                      <PreserveQueryRedirect to="/network/saved" />
                                    }
                                  />
                                  <Route
                                    path="/concierge"
                                  ...
                                  <Route
                                    ...
                                    element={<PublicOrderSharePage />}
                                  />
                                  <Route
                                    path="/share/with-me"
                                    element={<ShareWatchlistPage />}
                                  />
                                  <Route
                                    path="/partner-login"
                                  ...
                                  <Route
                                    path="/partners"
                                    element={<PartnerWithZivo />}
                                  />
                                  <Route
                                    path="/business"
                                    element={<BusinessSoftwarePortalPage />}
                                  />
                                  <Route
                                    path="/api-partners"
                                    element={<APIPartners />}
                                  ...
                                  <Route
                                    ...
                                    element={
                                      <AdminShellRoute
                                        vertical="business"
                                        title="Business Dashboard | ZIVO Admin"
                                      >
                                        <BusinessDashboard />
                                      </AdminShellRoute>
                                    }
                                  ...
                                  {/* Support */}
                                  <Route
                                    path="/support/travel-bookings"
                                    element={<TravelBookingsSupport />}
                                  />
                                  <Route
                                    path="/support/site-issues"
                                    element={<SiteIssuesSupport />}
                                  />
                                  <Route
                                    path="/support/tickets"
                                    element={
                                      <ProtectedRoute>
                                        <UserSupportTicketsPage />
                                      </ProtectedRoute>
                                    }
                                  />
                                  <Route
                                  ...
                                  />
                                  <Route
                                    path="/guides/cheap-flights"
                                    element={<CheapFlightsGuide />}
                                  />
                                  <Route
                                    path="/guides/best-time-to-book"
                                    element={<BestTimeToBook />}
                                  />
                                  <Route
                                    path="/guides/:citySlug"
                                    element={<CityGuide />}
                                  />
                                  ...
                                  <Route
                                    path="/:countrySlug"
                                    element={<CountryHubPage />}
                                  />
                                  <Route
                                    path="/:countrySlug/flights/:routeSlug"
                                    element={<LocalizedFlightRoutePage />}
                                  />

                                  {/* Dev-only QA. Do not expose demo/test routes in production. */}
                                  {ENABLE_DEV_ROUTES &&
                                    PostMenuRegressionPage &&
                                    SafeAreaQAPage &&
                                    ChatCallPreviewPage && (
                                      <>
                                        <Route
                                          path="/dev/post-menu-check"
                                          element={<PostMenuRegressionPage />}
                                        />
                                        <Route
                                          path="/dev/qa/safe-area"
                                          element={<SafeAreaQAPage />}
                                        />
                                        <Route
                                          path="/dev/chat-call-preview"
                                          element={<ChatCallPreviewPage />}
                                        />
                                      </>
                                    )}
