...
describe("shop owner workflow", () => {
  ...
  it("scopes owner-facing reads and writes by owner or store id", () => {
    ...
    const legacyPartnerOrigin = "https://hizivo" + ".com";
    expect(adminStores).not.toContain(`${legacyPartnerOrigin}/partner-login`);
    expect(adminStores).not.toContain(`${legacyPartnerOrigin}/help`);
    ...
    for (const template of [partnerInviteTemplate, partnerRecoveryTemplate]) {
      ...
      expect(template).not.toContain(`${legacyPartnerOrigin}/partner-login`);
      expect(template).not.toContain(`${legacyPartnerOrigin}/help`);
    }
