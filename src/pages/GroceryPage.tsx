        ...
        <div className="flex gap-2 px-4 pb-2 overflow-x-auto no-scrollbar">
          {marketStores.map((store) => (
            <button type="button"
              ...
              className={cn(
                "flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium whitespace-nowrap transition-all active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring shrink-0",
