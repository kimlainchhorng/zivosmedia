...
const MONETIZE_SECTIONS: Section[] = [
  ...
  },
  {
    ...
    articles: [
      ...
      { title: "ZIVO Creator Marketplace", description: "Get discovered by top brands through ZIVO's official creator marketplace and campaign partnerships...", views: "1.2M views", icon: Briefcase, iconBg: "bg-indigo-500/10", iconColor: "text-indigo-500" },
