...
export default function CarRentalReceiptPage() {
  ...
  const handlePrint = async () => {
    ...
    await printOrShareElement(mainRef.current, `receipt-${reservationId?.slice(0, 8) ?? "rental"}.pdf`, "Rental receipt");
  };
  ...
  return (
    <div className="min-h-screen bg-background print:bg-white">
        ...
        <div className="mx-auto max-w-3xl px-4 py-3 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-1.5">
            <Button size="sm" variant="outline" onClick={async () => {
              ...
              await exportBlob(doc.output("blob"), `receipt-${r.confirmation_code}.pdf`, "Rental receipt");
            }}>
      ...
      <main ref={mainRef} className="mx-auto max-w-3xl px-4 py-6 print:px-0 print:py-0">
        {/* Store header */}
