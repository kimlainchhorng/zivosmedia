  ...
  useEffect(() => {
    ...
    const schema = {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Guides", item: "https://zivollc.com/guides" },
        { "@type": "ListItem", position: 3, name: city.name, item: `https://zivollc.com/guides/${citySlug}` },
      ],
    };
  ...
  return (
    <>
      <Helmet>
        ...
        />
        <link rel="canonical" href={`https://zivollc.com/guides/${citySlug}`} />
      </Helmet>
