...
import {
  ...
  ArrowLeftRight, Hash, Coins, Image as ImageIcon, Receipt, Dumbbell, Unlock, Mic, ListTodo, ShieldAlert, MessageSquareHeart, Images, MessageCircleQuestion, Voicemail, AlertTriangle, Bug, ShieldCheck, Flame, ShieldOff, BellRing, Car, Send as SendIcon, Gavel, Plane, Radio, UserPlus, UtensilsCrossed, History, Briefcase, ListChecks, Eye, VolumeX, Banknote, MessageCircle, Scale, Headphones, Home as HomeIcon, Sticker, FileCheck, Building, Building2, Brain,
} from "lucide-react";
...
const GROUPS: LibraryGroup[] = [
  {
    ...
    sections: [
      ...
      { icon: HeartIcon, title: "Favorites", description: "Hotels, destinations, and places", path: "/saved-favorites" },
  ...
  },
  {
    ...
    sections: [
      ...
      { icon: Receipt, title: "Points History", description: "Loyalty points earned, redeemed, expired", path: "/points-history" },
      { icon: Receipt, title: "Transactions", description: "Marketplace payments and refunds", path: "/transactions" },
