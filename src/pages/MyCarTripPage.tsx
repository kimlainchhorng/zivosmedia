            ...
            >
              <div className="flex items-center justify-between mb-3">
                <div>
                  ...
                  <button type="button" onClick={copyBookingId} aria-label="Copy booking ID" className="flex items-center gap-1.5 mt-1 group transition-transform active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">
