...
import { ArrowLeft, ShoppingCart, Star, Clock, MapPin, Phone, Store, Package, Loader2, Plus, Minus, Sparkles, Heart, Eye, MessageCircle, Send, CalendarCheck, BedDouble, Lock, Share2, RefreshCcw } from "lucide-react";
        ...
        >
          ...
          <div className="lg:hidden mt-3 pt-3 border-t border-white/[0.06] flex flex-col gap-2.5">
            ...
            {(() => {
              const s = store as any;
              const socials = [
                s.facebook_url && isAllowedSocialUrl(s.facebook_url) && { icon: FacebookIcon, url: s.facebook_url, label: "Facebook", color: "#1877F2" },
                s.instagram_url && isAllowedSocialUrl(s.instagram_url) && { icon: InstagramIcon, url: s.instagram_url, label: "Instagram", color: "#E4405F" },
