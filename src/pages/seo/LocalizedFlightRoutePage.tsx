  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`https://zivollc.com/${countrySlug}/flights/${routeSlug}`} />
        <meta property="og:title" content={title} />
        <meta property="og:description" content={description} />
        
        {/* hreflang for international SEO */}
        <link rel="alternate" hrefLang="en-gb" href={`https://zivollc.com/uk/flights/${routeSlug}`} />
        <link rel="alternate" hrefLang="en-us" href={`https://zivollc.com/us/flights/${routeSlug}`} />
        <link rel="alternate" hrefLang="en-ca" href={`https://zivollc.com/ca/flights/${routeSlug}`} />
        <link rel="alternate" hrefLang="x-default" href={`https://zivollc.com/flights/${routeSlug}`} />
      </Helmet>
