...
const sections = [
  ...
  { icon: Palette, title: "2. Trademarks & Brand Assets", content: "ZIVO, the ZIVO logo, ZIVOSMEDIA.COM, and all related names, logos, product and service names, designs, slogans, and trade dress are trademarks or registered trademarks of ZIVO LLC. You may not use such marks without the prior written permission of ZIVO. All other names, logos, product and service names, designs, and slogans on the platform are the trademarks of their respective owners. Any unauthorized use of ZIVO's trademarks may result in legal action including injunctive relief and damages." },
  ...
  { icon: Globe, title: "8. DMCA & Copyright Infringement", content: "ZIVO respects intellectual property rights and complies with the Digital Millennium Copyright Act (DMCA). If you believe content on ZIVO infringes your copyright, submit a notice to our designated agent at legal@zivosmedia.com containing: (a) identification of the copyrighted work; (b) identification of the infringing material; (c) your contact information; (d) a statement of good faith belief; (e) a statement under penalty of perjury; (f) your physical or electronic signature. Repeat infringers will have their accounts terminated." },
