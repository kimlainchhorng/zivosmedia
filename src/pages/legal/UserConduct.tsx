...
const sections = [
  ...
  { icon: Globe, title: "9. Reporting Violations", content: "If you become aware of any violation of these conduct standards, you may report it to support@zivosmedia.com. ZIVO will investigate reports at its discretion but is not obligated to take action or inform you of the outcome. You agree not to make false or frivolous reports." },
  { icon: Smartphone, title: "10. Platform Integrity", content: "You agree not to take any action that could undermine the integrity, security, or proper functioning of the platform. This includes not manipulating search results, ratings, reviews, or prices; not engaging in coordinated inauthentic behavior; and not exploiting bugs or vulnerabilities (which must be reported to security@zivosmedia.com)." },
