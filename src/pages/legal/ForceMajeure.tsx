...
const sections = [
  ...
  },
  {
    ...
    content: "ZIVO will provide notice of Force Majeure Events affecting its services as soon as reasonably practicable through: (a) email notifications to affected users; (b) in-app announcements; (c) website status page updates at status.zivollc.com; (d) social media communications; and (e) push notifications where enabled. Failure to provide notice does not waive ZIVO's right to invoke Force Majeure protections. Users are responsible for independently monitoring conditions affecting their travel plans."
  },
  {
    icon: Scale,
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="p-4 max-w-2xl mx-auto space-y-5 pb-20">
        ...
        <div className="rounded-2xl bg-muted/30 border border-border/40 p-4 text-center space-y-1">
          ...
          <p className="text-xs text-muted-foreground">Check <span className="text-primary font-semibold">status.zivollc.com</span> for service updates</p>
        </div>
      </div>
    </div>
  );
