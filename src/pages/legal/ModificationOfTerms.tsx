...
const sections = [
  ...
  { icon: FileText, title: "6. Version History", content: "ZIVO maintains a record of all material changes to these Terms. The current version date is displayed at the top of each policy page. Previous versions may be available upon request by contacting legal@zivosmedia.com. However, ZIVO is not obligated to maintain or provide access to historical versions of the Terms." },
