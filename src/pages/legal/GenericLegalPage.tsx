...
export default function GenericLegalPage() {
  ...
  // Unknown legal slugs must NOT render fabricated boilerplate policy text (compliance risk).
  // Show a not-found state pointing at the real Legal Center instead.
  if (!custom) {
    return (
      <div className="min-h-screen bg-background">
        ...
        <div className="p-4 max-w-md mx-auto text-center space-y-4 pt-16 pb-20">
          ...
          <p className="text-sm text-muted-foreground">
            This legal page doesn't exist or may have moved. Browse all current ZIVO policies from the Legal Center.
          </p>
          <div className="flex flex-col gap-2">
            <Button onClick={() => navigate("/account/legal")}>Open Legal Center</Button>
            <Button variant="outline" onClick={() => navigate("/legal/terms")}>Terms of Service</Button>
          </div>
        </div>
      </div>
    );
