...
const sections = [
  ...
  { icon: EyeOff, title: "4. Right to Opt-Out of Sale/Sharing", content: "You have the right to opt out of the 'sale' or 'sharing' of your personal information. While ZIVO does not sell personal information in the traditional sense, certain data sharing with advertising partners may constitute a 'sale' under CCPA. To opt out, visit our 'Do Not Sell My Personal Information' page or contact privacy@zivosmedia.com." },
  { icon: Lock, title: "5. Right to Correct", content: "You have the right to request that ZIVO correct inaccurate personal information. Upon receiving a verified request, ZIVO will use commercially reasonable efforts to correct the information. You may submit correction requests through your account settings or by contacting privacy@zivosmedia.com." },
  ...
  { icon: FileText, title: "8. Submitting Requests", content: "To exercise your CCPA rights, submit a verifiable consumer request by: (a) emailing privacy@zivosmedia.com; (b) calling our toll-free number; (c) using the privacy request form in your account settings. We must verify your identity before fulfilling requests. Only you or an authorized agent may make a request on your behalf. We will respond within 45 days (extendable by an additional 45 days with notice)." },
  ...
  { icon: Globe, title: "10. Additional State Privacy Rights", content: "In addition to California, residents of Virginia (VCDPA), Colorado (CPA), Connecticut (CTDPA), Utah (UCPA), and other states with comprehensive privacy laws have similar rights. ZIVO extends the same privacy rights to all U.S. users regardless of state of residence. Contact privacy@zivosmedia.com to exercise your rights." },
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="p-4 max-w-2xl mx-auto space-y-5 pb-20">
        ...
        <div className="rounded-2xl bg-muted/30 border border-border/40 p-4 text-center space-y-1">
          ...
          <p className="text-xs text-muted-foreground">Contact <span className="text-primary font-semibold">privacy@zivosmedia.com</span></p>
        </div>
      </div>
    </div>
  );
