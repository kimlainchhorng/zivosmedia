...
const sections = [
  ...
  { icon: FileText, title: "4. Exercising Your Rights", content: "To exercise your GDPR rights, submit a request to gdpr@zivosmedia.com. We will: (a) acknowledge your request within 72 hours; (b) verify your identity; (c) respond to your request within 30 days (extendable by 60 days for complex requests); (d) provide a free copy of your data (reasonable fees may apply for additional copies); (e) inform any third-party recipients of corrections or deletions." },
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="p-4 max-w-2xl mx-auto space-y-5 pb-20">
        ...
        <div className="rounded-2xl bg-muted/30 border border-border/40 p-4 text-center space-y-1">
          ...
          <p className="text-xs text-muted-foreground">Contact <span className="text-primary font-semibold">gdpr@zivosmedia.com</span></p>
        </div>
      </div>
    </div>
  );
