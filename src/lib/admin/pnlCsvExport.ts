...
// CSV formula injection (CWE-1236): user-entered free-text (category, vendor,
// payment method, store name) reaches these cells; a value beginning with
// = + - @ tab or CR would execute as a formula in Excel/Sheets/LibreOffice.
