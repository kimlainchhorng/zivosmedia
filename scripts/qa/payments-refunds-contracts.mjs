...
function requirePostPaymentRoute(
  id,
  text,
  relativePath,
...
const contracts = [
    ...
    check() {
      ...
      for (const [relativePath, text] of [
        [
          ...
          source("supabase/functions/create-car-rental-deposit/index.ts"),
        ],
        [
          "supabase/functions/create-lodging-deposit/index.ts",
          source("supabase/functions/create-lodging-deposit/index.ts"),
        ],
        [
          "supabase/functions/create-salon-deposit/index.ts",
          source("supabase/functions/create-salon-deposit/index.ts"),
        ],
        [
          "supabase/functions/submit-lodging-refund-dispute/index.ts",
          source("supabase/functions/submit-lodging-refund-dispute/index.ts"),
        ],
        [
          "supabase/functions/create-payment-intent/index.ts",
          source("supabase/functions/create-payment-intent/index.ts"),
        ],
        [
          "supabase/functions/create-ride-payment-intent/index.ts",
          source("supabase/functions/create-ride-payment-intent/index.ts"),
        ],
        [
          "supabase/functions/create-ride-payment/index.ts",
          source("supabase/functions/create-ride-payment/index.ts"),
        ],
        [
          "supabase/functions/capture-ride-payment/index.ts",
          source("supabase/functions/capture-ride-payment/index.ts"),
        ],
      ]) {
        requirePostPaymentRoute(this.id, text, relativePath);
      }
      requirePostPaymentRoute(
        this.id,
        source("supabase/functions/resolve-bakong-ride-refund/index.ts"),
  ...
  },
  {
    ...
    check() {
      ...
      const providerEventsPath =
        "supabase/migrations/20260601154600_payment_provider_webhook_event_logs.sql";
