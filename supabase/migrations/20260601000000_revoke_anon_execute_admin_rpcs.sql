...
--
-- ⚠️ REVIEW BEFORE APPLYING. This file is staged, NOT auto-applied. The remote
-- migration history has known drift — apply through the normal preflight
-- (`npm run supabase:migrations:check` then your apply flow), and confirm each
-- function signature still matches production with:
