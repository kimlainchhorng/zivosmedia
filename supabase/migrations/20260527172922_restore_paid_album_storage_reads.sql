-- Restore locked album storage read checks after fixing unrelated storage RLS
-- failures. Group members may read album previews; originals require sender or
-- completed media_unlocks access.
