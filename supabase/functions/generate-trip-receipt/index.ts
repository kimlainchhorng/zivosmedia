...
Deno.serve(withSecurity("generate-trip-receipt", async (req, ctx) => {
  ...
  try {
    ...
    page.drawText("ZIVO is a travel marketplace operating at zivosmedia.com.", { x: 40, y: 64, size: 8, font, color: muted });
    page.drawText("Support: support@zivosmedia.com  ·  zivosmedia.com/legal", { x: 40, y: 52, size: 8, font, color: muted });
