...
export async function callFn(name: string, opts: CallOptions = {}): Promise<CallResult> {
  const headers = new Headers({
    ...
    "Origin": opts.origin ?? "https://zivollc.com",
    ...(opts.headers ?? {}),
  });
...
export async function preflight(name: string, origin = "https://zivollc.com"): Promise<CallResult> {
...
export function assertCors(res: CallResult, expectedOrigin = "https://zivollc.com") {
