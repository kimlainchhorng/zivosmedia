...
export const template = { component: Email, subject: (p: Props) => `Your ZIVO lodging receipt${p.reservationNumber ? ` — ${p.reservationNumber}` : ''}`, displayName: 'Lodging receipt ready', previewData: { guestName: 'Alex', propertyName: 'ZIVO Suites', reservationNumber: 'L-2048', downloadUrl: 'https://zivosmedia.com/receipt', generatedAt: 'Apr 23, 2026', expiresAt: 'Apr 30, 2026' } } satisfies TemplateEntry<Props>
