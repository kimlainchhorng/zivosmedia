...
function CountryChangeEmail({
  ...
  priorCountry = 'US',
  newCountry = 'XX',
  manageSecurityUrl = 'https://zivosmedia.com/account/security',
  notMeUrl = 'https://zivosmedia.com/account/security?action=lock',
}: CountryChangeProps) {
    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={card}>
          ...
          <Text style={footer}>© {new Date().getFullYear()} ZIVO · zivosmedia.com</Text>
        </Container>
      </Body>
    </Html>
  )
