...
Deno.serve(withSecurity("connect-onboard-stylist", async (req, ctx) => {
  ...
  try {
    ...
    const appUrl =
      Deno.env.get("PUBLIC_APP_URL") || Deno.env.get("SITE_URL") || req.headers.get("origin") || "https://zivosmedia.com";
